...
import { INITIAL_AIRPORT_STATE, GAME_NAME, UPGRADE_COSTS, VEHICLE_COSTS, DEFAULT_LOCATION } from './constants';
...
type GamePhase = 'loading_save' | 'playing';
...
const App: React.FC = () => {
  ...
  }, [session, addToLog, gamePhase, isLoading, handleStartGame]);
